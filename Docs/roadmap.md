...
Осталось: запушить ветку и включить Actions. Метка раннера `macos-26`
задаётся входом воркфлоу; если она недоступна аккаунту, перезапустить с
`macos-15` и посмотреть шаг «Toolchain».
