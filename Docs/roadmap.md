...
- ☑ **Разбор правилами на живой речи.** Действие без названия относится к
  ...
  распознанном GigaAM.
- ☑ 233 теста ядра зелёные в Docker и на Apple-тулчейне; сборка iOS с
  sherpa-onnx на CI зелёная.
- ☐ Проверка на телефоне по `Docs/testing-round-2.md`: запись, модель на
  телефоне (скорость на iPhone ещё не измерена), разрешения, уведомление с
  «Рассказать».
