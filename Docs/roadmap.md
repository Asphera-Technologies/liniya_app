...
- ☑ **Распознавание русской речи на телефоне.** Своя модель GigaAM-v3 (Сбер,
  ...
  скачана — xAI с согласия человека или системная диктовка. Голос удаляется
  сразу после распознавания.
- ☑ **Разбор рассказа.** Моделью grok-4.3 (строгий JSON, проверка ответа) или
  правилами без сети. Модель выбрана по живому сравнению трёх вариантов.
