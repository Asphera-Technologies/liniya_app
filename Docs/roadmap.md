...
- ☑ **Распознавание русской речи.** xAI `grok-voice-transcribe-2.0` с согласия
  человека, запасной — iPhone (`DictationTranscriber` на iOS 26+,
  `SFSpeechRecognizer` на устройстве на iOS 18–25). Новая модель Apple русского
  не знает. xAI проверен вживую. Голос удаляется сразу после распознавания.
...
- ☑ 229 тестов ядра зелёные в Docker и на Apple-тулчейне.
- ☐ Сборка iOS на CI — см. журнал.
- ☐ Проверка на телефоне: запись, распознавание на iPhone, разрешения,
  уведомление с «Рассказать».
