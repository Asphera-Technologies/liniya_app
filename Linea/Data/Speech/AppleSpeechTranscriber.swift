...
//  Linea
//
//  Системная диктовка iPhone — запасной путь, пока модель GigaAM не скачана:
//  бесплатно, без сети, запись никуда не уходит. Для русского точность
//  заметно ниже GigaAM, часто без знаков препинания.
//
...
/// Основной распознаватель — модель на телефоне; не справилась — системная
/// диктовка. Итог дня не теряется ни при каком отказе.
