...
nonisolated enum CheckInText {
    ...
    static let positiveStems = [
        ...
        "позвонил", "поговорил", "приготовил", "выучил", "заказал", "забрал", "отнес",
        "подписал", "оформил", "проверил", "протестировал", "исправил", "настроил",
        "пробежал", "поплавал", "погулял", "помыл", "навел",
    ]
    ...
    static let hardPhrases: [[String]] = [["нет", "сил"], ["сил", "нет"], ["без", "сил"], ["не", "было", "сил"], ["не", "выспался"], ["не", "выспалась"]]
    ...
    static let lowEnergyPhrases: [[String]] = [["нет", "сил"], ["сил", "нет"], ["без", "сил"], ["не", "было", "сил"], ["не", "выспался"], ["не", "выспалась"]]
